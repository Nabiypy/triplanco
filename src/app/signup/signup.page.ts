  ...
  register() {
    if (this.validateRegister(this.form)) {
      this.spinnerDialog.show('Triplanco',
        this.translate.instant('ALERT.creatingprofile'),
        false
      );
    ...
    this.facebook
      ...
      .then(response => {
        ...
        firebase
          ...
          .then(success => {
            console.log('Firebase Facebook success: ' + JSON.stringify(success));
                ...
                this.chatProvider.getLocation().then(data => {
                  ...
                  geoFire
                    ...
                    .then(() => {
                      ...
                      this.authProvider.isLoggedIn = true;
                      this.showToast(
                        this.translate.instant('ALERT.welcometochatme')
                      );
                    });
                });
              });
